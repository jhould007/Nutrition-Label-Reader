...
# Create main label
top_label = Label(window, text="Please click the upload button and upload a close-up image of an ingredient list to get started.", fg="black", font=("Arial", 16),
